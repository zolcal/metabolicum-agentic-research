...
- **Expansion:** same pipeline for other 0-cohort categories (kidney-function, electrolytes, …) — change only the marker list; run channel audit + fix before ingest each time.
